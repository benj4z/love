...
(function () {
    ...
    const LOVE_MESSAGE_BLOCK = document.querySelector('.love-message');
    LETTER_BLOCK.addEventListener('click', () => {
        LETTER_BLOCK.classList.add('letter-fade-away')
        setTimeout(() => {
            LOVE_MESSAGE_BLOCK.classList.add('love-message-appear');
        }, 450)
        setTimeout(() => {
            LOVE_MESSAGE_BLOCK.classList.add('love-message-fade-in');
        }, 480)
    })
})();
